...
易得：$P(B=blue|F=o)=\frac{1}{3}$   
在上面的计算过程中，我们将$P(B=blue)$称为先验概率（prior probability），因为我们在得到F是“a”或者“o”之前，就可以得到 
 。同理，将$P(B=red|F=o)$称为后验概率，因为我们在完整的一次实验之后也就是得到了F的具体取值之后才能得到这个概率。  
